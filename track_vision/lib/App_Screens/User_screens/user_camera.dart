...
import 'package:track_vision/App_Screens/User_screens/widgets/camera_scan_page.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // show last scan from loacal storage
            if (scanState.lastCode != null) ...[
              const Text(
                'Last stored scan:',
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              Text('Code: ${scanState.lastCode}'),
              if (scanState.lastScannedAt != null)
                Text('Time: $scanState.lastScannedAt}'),
            ],
          ],
        ),
      ),
