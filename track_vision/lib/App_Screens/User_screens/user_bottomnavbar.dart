...
import 'package:track_vision/App_Screens/User_screens/user_appbar.dart';
import 'package:track_vision/App_Screens/User_screens/user_camera.dart';
import 'package:track_vision/App_Screens/User_screens/user_complains.dart';
import 'package:track_vision/App_Screens/User_screens/user_dashboard.dart';
...
class _UserBottomNavbarState extends ConsumerState<UserBottomNavbar> {
  ...
  final List<String> _labels = ['Home', 'Complaints', 'Camera'];

  @override
  Widget build(BuildContext context) {
    final selectedIndex = ref.watch(uBottomNavIndexProvider);

    final userPages = [UserDashboard(), UserComplains(), UserCamera()];
