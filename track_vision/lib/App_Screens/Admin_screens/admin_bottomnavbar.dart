...
import 'package:track_vision/App_Screens/Admin_screens/admin_appbar.dart';
import 'package:track_vision/App_Screens/Admin_screens/admin_camera.dart';
import 'package:track_vision/App_Screens/Admin_screens/admin_complains.dart';
...
class _AdminBottomNavbarState extends ConsumerState<AdminBottomNavbar> {
  ...
  Widget build(BuildContext context) {
    ...
    final adminPages = [AdminDashboard(), AdminComplains(), AdminCamera()];
    return Scaffold(
      appBar: AdminAppbar(),
