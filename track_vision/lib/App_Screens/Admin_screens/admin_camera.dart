...
import 'package:track_vision/App_Screens/Admin_screens/widgets/admin_ipcamera.dart';
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => IPCamera()),
                );
              },
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Connect with existing IP camera to see live.",
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w700,
                        color: Colors.black54,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Install the App from the AppStore/PlayStore",
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w700,
                      color: Colors.black54,
                  ...
                  Text(
                    "to scan with your mobile camera.",
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w700,
                      color: Colors.black54,
