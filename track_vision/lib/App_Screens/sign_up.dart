  ...
  Future<void> _submit() async{
    ...
    if(authState.status !=AuthStatus.error){
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(_selectedRole == 'User' ? 'User signed up successfully!' : 'Admin signed up successfully!')
          )
      );
            ...
            key: _formKey,
              child: Column(
                ...
                children: [
                  ...
                  const Center(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10,),
                        const Text("Fill your Information below or", style: TextStyle(
                  ...
                  const Text("Select Role", style: TextStyle(
                    fontSize: 14, fontWeight: FontWeight.w600, color: ConstantColors.textDarkMode
                  ),),
